...
Rectangle {
    ...
    MouseArea {
        hoverEnabled: true
        onEntered: { filterBox.state = "in"; filterBox.forceActiveFocus() }
        onHoveredChanged: { filterBox.state = "out"; filterBox.forceActiveFocus() }
    ...
    Component.onCompleted: filterBox.forceActiveFocus()
}
// Tabs hechos.
