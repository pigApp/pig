...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) .tmp/PIG1.0.0/ && $(COPY_FILE) --parents qml.qrc .tmp/PIG1.0.0/ && $(COPY_FILE) --parents src/pig.h src/password/pass.h src/update/update.h src/socket/tcpSocket.h src/video/videoplayer.h .tmp/PIG1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/pig.cpp src/password/pass.cpp src/update/update.cpp src/socket/tcpSocket.cpp src/video/videoplayer.cpp .tmp/PIG1.0.0/ && (cd `dirname .tmp/PIG1.0.0` && $(TAR) PIG1.0.0.tar PIG1.0.0 && $(COMPRESS) PIG1.0.0.tar) && $(MOVE) `dirname .tmp/PIG1.0.0`/PIG1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/PIG1.0.0
...
compiler_moc_header_make_all: moc_pig.cpp moc_pass.cpp moc_update.cpp moc_tcpSocket.cpp moc_videoplayer.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_pig.cpp moc_pass.cpp moc_update.cpp moc_tcpSocket.cpp moc_videoplayer.cpp
...
moc_tcpSocket.cpp: src/socket/tcpSocket.h
	/usr/lib/qt/bin/moc $(DEFINES) -I/usr/lib/qt/mkspecs/linux-g++ -I/home/ok200/pig -I/usr/include/qt -I/usr/include/qt/QtMultimediaWidgets -I/usr/include/qt/QtQuick -I/usr/include/qt/QtMultimedia -I/usr/include/qt/QtQml -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtSql -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/4.9.0 -I/usr/include/c++/4.9.0/x86_64-unknown-linux-gnu -I/usr/include/c++/4.9.0/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.0/include-fixed -I/usr/include src/socket/tcpSocket.h -o moc_tcpSocket.cpp
...
main.o: src/main.cpp src/socket/tcpSocket.h \
		src/pig.h \
		src/password/pass.h \
		src/update/update.h \
		src/video/videoplayer.h
...
pig.o: src/pig.cpp src/socket/tcpSocket.h \
		src/pig.h \
		src/password/pass.h \
		src/update/update.h \
		src/video/videoplayer.h
...
tcpSocket.o: src/socket/tcpSocket.cpp src/socket/tcpSocket.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tcpSocket.o src/socket/tcpSocket.cpp
